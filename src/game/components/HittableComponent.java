...
public class HittableComponent extends EntityComponent {
	public static final int ID = IDAssigner.getId();
	public static final int TYPE_COLLECTABLE = 0;
	public static final int TYPE_HAZARD = 1;
	public static final int TYPE_ENEMY_HAZARD = 2;

	private int type;
	private double damage;

	public HittableComponent(Entity entity, int type) {
		this(entity, type, 1.0);
	}

	public HittableComponent(Entity entity, int type, double damage) {
		super(entity, ID);
		this.type = type;
		this.damage = damage;
	}
