...
public class AABB {
	...
	/**
	 * Creates an AABB that bounds both this AABB and another AABB, ignoring the Z axis.
	 * 
	 * @param other
...
//		double maxZ = Math.max(this.maxZ, other.getMaxZ());
	...
	/**
	 * Creates a new AABB equivalent to this, but scaled away from it's center by
	 * a certain amount.
	 * 
	 * @param scaleX
	 *            Amount to scale on X.
	 ...
	 * @return A new AABB, scaled by the specified amounts.
	 */
	public AABB localScale(double scaleX, double scaleY) {
		double centerX = getCenterX();
		double centerY = getCenterY();
		return new AABB(
				(minX-centerX)*scaleX+centerX, (minY-centerY)*scaleY+centerY, minZ, 
				(maxX-centerX)*scaleX+centerX, (maxY-centerY)*scaleY+centerY, maxZ);
	}
}
