...
public abstract class EntityComponent {
	...
	/**
	 * Called when entity attempts to move, but before the move is finalized
	 * 
	 * @param amts
	 *            How much the entity is trying to move in both X and Y. Can be
	 *            set or updated to change the movement.
	 */

	public void onMove(DoublePair amts) {
	}
